...
const WeatherComponent: FC<WeatherComponentProps> = ({position}) => {
    ...
    useEffect(() => {
        WeatherApiService.getWeatherAtCurrentPosition().then(async r => setWeather(r))
    }, [position]);
            ...
            {weather && (
                <div
                    ...
                    <div className="flex flex-row gap-4">
                        {weather.weatherDescription.toLowerCase().includes('rain') || weather.weatherDescription.toLowerCase().includes('cloud')
